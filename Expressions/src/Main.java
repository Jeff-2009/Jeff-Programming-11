public class Main {
    public static void main(String args[]){
        ...
        //Expression 1
        System.out.println((9 - 4)+ 10/2 - (4 - 8)/3.0);
        System.out.println(5 + 10/2 - (4 - 8)/3.0);
        System.out.println(5 + 10/2 - (-4.0)/3.0);
        System.out.println(5 + 5 - (-4.0)/3);
        System.out.println(5 + 5 - (- 1.3333333333333333));
        System.out.println(10 - (-1.3333333333333333));
        System.out.println(11.333333333333334);



        //Expression 2
        System.out.println(23%4 + (18 - 3.0 / 2));
